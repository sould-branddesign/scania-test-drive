...
(function () {
  ...
  const T = {
    ...
    cs: { chooseLanguage: 'Vyberte jazyk', welcome: 'Vítejte v hodnocení vaší zkušební jízdy.', chooseVehicle: 'Vyberte si vozidlo:', next: 'Další', back: 'Zpět', submit: 'Odeslat', confirmTitle: 'Jste si jisti?', confirmMsg: 'Po odeslání se nebudete moci vrátit a změnit své odpovědi.', done: 'Hotovo', selectCategory: 'Vyberte kategorii', thanks: 'Děkujeme!', submitted: (v) => `Vaše hodnocení pro ${v} bylo odesláno.`, nextCar: 'Další kamion', startOver: 'Začít znovu', tap: 'Klepnutím zahájíte', restarting: (n) => `Restartování za ${n}s` },
    da: { chooseLanguage: 'Vælg sprog', welcome: 'Velkommen til evalueringen af din prøvekørsel.', chooseVehicle: 'Vælg dit køretøj:', next: 'Næste', back: 'Tilbage', submit: 'Indsend', confirmTitle: 'Er du sikker?', confirmMsg: 'Når du har indsendt, kan du ikke gå tilbage og ændre dine svar.', done: 'Færdig', selectCategory: 'Vælg en kategori', thanks: 'Tak!', submitted: (v) => `Dine vurderinger for ${v} er indsendt.`, nextCar: 'Næste lastbil', startOver: 'Start forfra', tap: 'Tryk for at starte', restarting: (n) => `Genstarter om ${n}s` },
    ...
    sk: { chooseLanguage: 'Vyberte jazyk', welcome: 'Vitajte v hodnotení vašej skúšobnej jazdy.', chooseVehicle: 'Vyberte si vozidlo:', next: 'Ďalej', back: 'Späť', submit: 'Odoslať', confirmTitle: 'Ste si istí?', confirmMsg: 'Po odoslaní sa nebudete môcť vrátiť a zmeniť svoje odpovede.', done: 'Hotovo', selectCategory: 'Vyberte kategóriu', thanks: 'Ďakujeme!', submitted: (v) => `Vaše hodnotenia pre ${v} boli odoslané.`, nextCar: 'Ďalší kamión', startOver: 'Začať odznova', tap: 'Klepnite pre spustenie', restarting: (n) => `Reštartovanie za ${n}s` },
